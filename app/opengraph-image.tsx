  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <img src={toriiIconUri} width={140} height={102} />
          <img
            src={wordmarkUri}
            width={400}
            height={52}
        ...
        {/* Main copy — left-aligned, pushed to bottom */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
